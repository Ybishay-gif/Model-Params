...
import { getPlanMergedAnalytics, getPriceExploration, getStrategyAnalysis, getStateSegmentPerformance, listPlanMergedFilters, listPriceExplorationFilters, listStateSegmentFilters } from "../services/analyticsService.js";
import { appendDecisions, createPlan, createRun, getPlan, listPlanParameters, getRun, getRunResults, listPlans, upsertParameters } from "../services/plansService.js";
...
import { addManagedUser, getUserLoginState, listManagedUsers, loginAdminWithCode, loginUser, logoutSession, resetManagedUserPassword, setupUserPassword } from "../services/authService.js";
...
plansRouter.get("/analytics/state-segment-performance", async (req, res, next) => {
    try {
        const qbc = typeof req.query.qbc === "string" && req.query.qbc.trim() !== ""
